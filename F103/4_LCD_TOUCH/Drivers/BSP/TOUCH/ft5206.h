...
#define FT5206_RST_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOF_CLK_ENABLE(); }while(0)   /* PF口时钟使能 */

#define FT5206_INT_GPIO_PORT            GPIOF
#define FT5206_INT_GPIO_PIN             GPIO_PIN_10
#define FT5206_INT_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOF_CLK_ENABLE(); }while(0)   /* PF口时钟使能 */
